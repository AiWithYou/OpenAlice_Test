...
const demoHeadlessTasks = [
  {
    ...
    agent: 'codex',
    promptPreview: 'Compute a quant snapshot of NVDA and push a report to the inbox.',
    status: 'done',
  ...
  },
  {
    ...
    wsId: 'demo-chat',
    agent: 'claude',
    promptPreview: "Summarize today's AI-sector headlines and flag anything actionable.",
    status: 'running',
    startedAt: now - 6_000,
  },
  {
    ...
    wsId: 'demo-finance-research',
    agent: 'pi',
    promptPreview: 'Refresh the uranium watchlist and note any breakouts.',
    status: 'interrupted',
